# nvim-treesitter-queries-c3

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-c3/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-c3/actions/workflows/validate.yml)

Neovim tree-sitter queries for **c3**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-c3",
...
- [ ] Changes are scoped to `c3` — do not include files for other languages
